...
import com.charan.setupBox.presentation.components.CustomTextField
import com.charan.setupBox.presentation.components.CustomTextForPackages
import com.charan.setupBox.data.local.entity.SetupBoxContent
import com.charan.setupBox.presentation.components.PreviewAlertBox
                ...
                actions = {
                    if(id!=-1) {
                        IconButton(onClick = {
                            ...
                            viewModel.deleteSupabase(id!!).observe(lifecycle) {
                                when (it) {
